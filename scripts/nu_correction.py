...
from ext.SplineSmooth3D import SplineSmooth3DUnregularized
...
mask = np.ones(im0.shape) > 0
dataSub = im0
dataVoxSize = nib.affines.voxel_sizes(aff2)
affineSub = np.copy(aff2)
...
predictor = SplineSmooth3D(im0, dataVoxSize,
